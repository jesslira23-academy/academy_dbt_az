with
    ...
    , seed_nova_segmentacao as (
        select 
            pais_destinatario
            , segmentacao
        from {{ ref('seed_depara_pais_segmentacao') }}
    )
    ...
    , joined as (
        select
            ...
            , seed_nova_segmentacao.segmentacao -------< segmentacao nova vindo da seed 
        ...
        left join seed_nova_segmentacao
            on pedido.pais_destinatario = seed_nova_segmentacao.pais_destinatario
    )
